...
This is a minor mode.  If called interactively, toggle the `Js2-Imenu-Extras
...
`Js2-Highlight-Unused-Variables mode' mode.  If the prefix argument is positive,
...
This is a minor mode.  If called interactively, toggle the `Js2 minor mode'
