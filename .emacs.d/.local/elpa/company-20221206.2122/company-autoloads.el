...
This is a minor mode.  If called interactively, toggle the `Company mode' mode.
...
This is a minor mode.  If called interactively, toggle the `Company-Tng mode'
...
To check whether the minor mode is enabled in the current buffer, evaluate
`(default-value \\='company-tng-mode)'.
