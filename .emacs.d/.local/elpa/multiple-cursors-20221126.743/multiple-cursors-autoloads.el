...
`Mc-Hide-Unmatched-Lines mode' mode.  If the prefix argument is positive, enable
...
This is a minor mode.  If called interactively, toggle the `Multiple-Cursors
...
This is a minor mode.  If called interactively, toggle the `Rectangular-Region
mode' mode.  If the prefix argument is positive, enable the mode, and if it is
zero or negative, disable the mode.
