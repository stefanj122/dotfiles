...
This is a minor mode.  If called interactively, toggle the `skewer-css mode'
...
This is a minor mode.  If called interactively, toggle the `skewer-html mode'
mode.  If the prefix argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
...
This is a minor mode.  If called interactively, toggle the `skewer mode' mode.
