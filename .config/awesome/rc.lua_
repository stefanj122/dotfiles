...
globalkeys = my_table.join(
	...
	end, { description = "edit config files", group = "dmenu scripts" }),
	awful.key({ altkey, "Control" }, "m", function()
		awful.util.spawn("./.dmenu/dmenu-sysmon.sh")
	end, { description = "system monitoring apps", group = "dmenu scripts" }),
	awful.key({ altkey, "Shift" }, "p", function()
		awful.util.spawn("bwmenu -C")
	end, { description = "passmenu", group = "dmenu scripts" }),
	awful.key({ altkey, "Control" }, "p", function()
		awful.util.spawn(
			"bitwarden-dmenu --dmenu-args='-i' --clear-clipboard 30 --session-timeout 100 --sync-vault-after 3600"
		)
	end, { description = "bitwarden", group = "dmenu scripts" }),
	...
	end, { description = "ncpamixer", group = "terminal apps" }),
	awful.key({ altkey }, "r", function()
		awful.util.spawn(terminal .. " -e ranger")
	end, { description = "ranger", group = "terminal apps" }),
	awful.key({ altkey }, "s", function()
		awful.util.spawn("steam && killall picom")
	end, { description = "Steam", group = "gui apps" }),
	awful.key({ altkey, "Control" }, "s", function()
		awful.util.spawn("spotify-launcher")
	end, { description = "Spotify", group = "gui apps" }),
	...
	end, { description = "Lutris", group = "gui apps" }),
	awful.key({ modkey, altkey }, "c", function()
		awful.util.spawn(terminal .. " -e cmus")
	end, { description = "cmus", group = "terminal apps" }),
	awful.key({ altkey }, "f", function()
		awful.util.spawn("firefox")
	end, { description = "Firefox", group = "gui apps" }),
	...
	end, { description = "Show notification", group = "hotkeys" }),
	awful.key({ altkey, "Shift" }, "e", function()
		awful.util.spawn("emacsclient -c")
	end, { description = "Run emacs", group = "termianl apps" }),
	-- screenshots
	awful.key({}, "Print", function()
		awful.util.spawn_with_shell("maim /home/stefanj/Pictures/$(date +%m-%d-%y-%H-%M-%S-screenshot).png")
	end, { description = "Meim fullscreen", group = "screenshots" }),
	awful.key({ modkey }, "Print", function()
		awful.util.spawn_with_shell("maim -s /home/stefanj/Pictures/$(date +%m-%d-%y-%H-%M-%S-screenshot).png")
	end, { description = "Meim select windows", group = "screenshots" }),
	-- Personal keybindings}}}
	...
	awful.key({ modkey }, "Shift_R", function()
		awful.spawn.easy_async_with_shell("setxkbmap -layout us,rs,rs -variant ,latin && xkb-switch -n", function()
			beautiful.keyboard.update()
		end)
	...
	end, { description = "VS Code", group = "gui apps" }),
	awful.key({ altkey }, "h", function()
	...
	awful.key({ modkey, "Shift" }, "e", function()
		awful.spawn.with_shell("alacritty -e nvim ~/.config/awesome/rc.lua")
	...
	awful.key({}, "XF86MonBrightnessDown", function()
		awful.spawn.easy_async_with_shell("brightnessctl s 5%- && bright.sh", function()
			beautiful.bright.update()
		end)
	end),
	...
	awful.key({}, "XF86AudioRaiseVolume", function()
		awful.spawn.easy_async_with_shell("pamixer --allow-boost --set-limit 150 -i 3 && vol.sh", function()
			beautiful.volume.update()
		end)
	end),
	--awful.key({ modkey1 }, "Down",
	awful.key({}, "XF86AudioLowerVolume", function()
		awful.spawn.easy_async_with_shell("pamixer --allow-boost --set-limit 150 -d 3 && vol.sh", function()
			beautiful.volume.update()
		end)
	end),
	...
	awful.key({ altkey }, "p", function()
		awful.spawn.easy_async_with_shell("mpd.sh", function() end)
	end),
