...
-- Brightness
bright = wibox.widget.imagebox('/home/stefanj/.config/awesome/themes/powerarrow-blue/icons/bright.png')
theme.bright = lain.widget.bright({
    settings = function()
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#A77AC4"),
            arrow("#A77AC4", "#7197E7"),
            ...
            arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, mpdicon,  layout = wibox.layout.align.horizontal }, 3, 3), "#A77AC4"),
            arrow("#A77AC4", "#7197E7"),
