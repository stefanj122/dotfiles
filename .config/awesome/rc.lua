...
globalkeys = my_table.join(
    ...
    awful.key({ altkey }, "e" , function () awful.util.spawn ( "ulauncher-toggle") end,
        {description = "Ulauncher" , group = "gui apps" }),
    ...
    awful.key({ modkey,           }, "Shift_R", function ()
         awful.spawn.easy_async_with_shell("xkb-switch -n",function() beautiful.keyboard.update() end)end,
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ }, "XF86MonBrightnessDown", function ()
        awful.spawn.easy_async_with_shell("xbacklight -dec 10",function() beautiful.bright.update() end) end),
    awful.key({ }, "XF86MonBrightnessUp", function ()
        awful.spawn.easy_async_with_shell("xbacklight -inc 10",function() beautiful.bright.update() end) end),
