...
globalkeys =
    ...
    -- dmenu
        ...
        awful.key(
            ...
            "k",
            function()
                awful.spawn.with_shell("exec /home/stefanj/.scripts/kill.sh")
            end
        ),
        -- Brightness
        awful.key(
        ...
        awful.key(
            ...
            function()
                awful.spawn.easy_async_with_shell(
                    "pamixer --allow-boost --set-limit 150 -i 3 && vol.sh",
                    function()
        ...
        awful.key(
            ...
            function()
                awful.spawn.easy_async_with_shell(
                    "pamixer --allow-boost --set-limit 150 -d 3 && vol.sh",
                    function()
                        beautiful.volume.update()
                    end
                )
...
awful.spawn.easy_async_with_shell(
    "setxkbmap -layout us,rs,rs -variant ,latin",
    function()
    end
)
